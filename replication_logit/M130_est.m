diary M130_est_logit_modification.text
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Estimate parameters for year 2006
% Probit model with Lambda = 1
% modified by Tong LI
% Panle Jia 5/21/08
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear
